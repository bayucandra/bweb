...
<body>
	<div id="b-wrap" class="sh">
		...
		<div id="b-header">
			...
			<div id="menu-wrap">
				<ul>
					<li{$page_is_home}><a href="{$url_home}">Home</a></li>
					<li{$page_is_about}><a href="{$url_about}">About Us</a></li>
					<li{$page_is_products}><a href="{$url_products}">Products</a></li>
					<li{$page_is_catalog}><a href="{$url_catalog}">Catalog</a></li>
					<li{$page_is_contact}><a href="{$url_contact}">Contact Us</a></li>
					<li{$page_is_link}><a href="{$url_link}">Links</a></li>
				</ul>
			</div>
		</div>
